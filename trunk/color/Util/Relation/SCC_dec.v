...
Theorem SCC_effective_exact M (H: M= SCC_mat_effective): forall x y, SCC R x y <-> SCC_effective H x y.
...
Lemma SCC_effective_dec :forall  M (H: M= SCC_mat_effective) x y, {SCC_effective H x y  } + {~SCC_effective H x y}.
Proof.
