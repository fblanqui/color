...
In an arbitrary set with decidable (resp. middle-excluding) equality, a binary relation  is decidable (resp. middle-excluding) 
iff the transitive closures of its finite restrictions are decidable (resp. middle-excluding)
*)

(* $Id: RelDec.v,v 1.4 2007-02-23 14:20:53 stephaneleroux Exp $ *)
