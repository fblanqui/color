...
(** * Basic properties of CP structures. *)
  ...
  Module Facts (Import CP : CP_Struct).
    ...
    Proof.
      ...
      (* trans *)
      destruct (IHclos_aeq_trans1 x' u' (refl_equal _))
        as [y0 [v0 [h1 h2]]]. subst v.
      destruct (IHclos_aeq_trans2 y0 v0 (refl_equal _))
    ...
    Proof.
      ...
      intro y. unfold comp. unfold_single. unfold LSubs.update at 2.
      unfold LSubs.update at 3. eq_dec y x; simpl.
...
(** ** Interpretation of arrow types. *)
    ...
    Definition arr (P Q : pred) u := forall v, P v -> Q (App u v).
