...
Lemma path_nth_inP : forall x y l k,
  path x y l -> S k < length l -> R (nth k l y) (nth (S k) l y).

Proof.
intros x y l. generalize x y. clear x y. induction l.
...
Lemma path_lastP : forall x y l k,
  path x y l -> S k = length l -> R (nth k l y) y.

Proof.
intros x y l k. generalize x y l. clear x y l. induction k.
...
Lemma path_headP : forall x y l, path x y l -> R x (nth 0 l y).
