...
(* $Id: Cycle.v,v 1.7 2007-02-23 14:20:53 stephaneleroux Exp $ *)
...
Proof.
intros. unfold cycle_min. deduce (repeat_free_intro eq_dec (x::l)). decomp H0.
(* repeat_free (x::l) *)
...
rewrite H5 in H2. deduce (repeat_free_app_elim H2). simpl in H0. decomp H0. intuition.
(* cycle x1 x4 *)
