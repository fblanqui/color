...
Proof.
intro. eapply WF_incl. apply red_mod_incl. apply hyp4. apply hyp2.
eapply Fred_mod_WF. eapply WF_incl. apply red_mod_incl. apply hyp3.
apply hyp1. hyp.
Qed.
...
Lemma WF_Fred_mod_iso : WF (red_mod E R) <-> WF (red_mod (Frs HF E) (Frs HF R)).
