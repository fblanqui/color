...
(** ** Properties of [var]. *)
  ...
  Proof.
    ...
    unfold Def.var; ens. rewrite fvcodom_id, empty_b. apply (f_equal (Lam x)).
    rewrite <- IHu at 2. apply subs_seq. intros y hy. unfold Def.update.
  ...
  Proof.
    ...
    unfold Def.update. eq_dec a x. subst a. absurd (x=x); tauto.
    intuition.
